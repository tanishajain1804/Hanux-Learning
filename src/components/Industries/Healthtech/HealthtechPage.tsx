...
const themeColors = {
  primary: "#ef4444", secondary: "#f97316", lightBg: "#fee2e2", gradient: "linear-gradient(135deg, #ef4444 0%, #f97316 100%)"
};

const metaData = {
  stats: [["70+", "HealthTech Platforms"], ["5M+", "Patients Served"], ["HIPAA", "Compliant Always"]] as [string, string][],
  trust: ["HIPAA Compliant ✓", "HL7 FHIR R4 ✓", "DICOM Support ✓", "ICD-10 Coding ✓", "ISO 13485 ✓", "ABDM Integrated ✓", "Telemedicine Ready ✓", "AI Diagnostics ✓"],
  checks: ["HIPAA & ABDM compliant architecture", "HL7 FHIR R4 interoperability standards", "Telemedicine with HD video consultations", "AI-assisted diagnostic & triage tools", "Patient engagement & chronic care management"],
  h1: ["Transforming ", "Healthcare", " Through Intelligent Software"] as [string, string, string]
};

import { IndustryCanvas } from "../IndustryCanvas";

export const HealthtechPage: React.FC = () => {
  const industryKey = "healthtech";
