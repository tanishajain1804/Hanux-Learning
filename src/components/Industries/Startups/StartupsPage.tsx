...
const themeColors = {
  primary: "#1b4fd8", secondary: "#6366f1", lightBg: "#eef2ff", gradient: "linear-gradient(135deg, #1b4fd8 0%, #6366f1 100%)"
};

const metaData = {
  stats: [["200+", "Startups Launched"], ["$800M+", "Funding Raised by Clients"], ["3x", "Avg. Growth Rate"]] as [string, string][],
  trust: ["Seed-to-Series B ✓", "MVP in 4 Weeks ✓", "Equity-Friendly Pricing ✓", "NDAs Always ✓", "24/7 Support ✓", "Scalable Architecture ✓", "Agile Delivery ✓", "Post-Launch Support ✓"],
  checks: ["MVP delivery in 4–8 weeks", "Investor-ready architecture and code quality", "Technical due diligence support for fundraising", "Post-funding team scaling & handover", "SaaS, marketplace, mobile & AI products"],
  h1: ["Launch Your ", "Startup", " With Expert Tech Partners"] as [string, string, string]
};

import { IndustryCanvas } from "../IndustryCanvas";

export const StartupsPage: React.FC = () => {
  const industryKey = "startups";
