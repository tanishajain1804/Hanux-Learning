...
const themeColors = {
  primary: "#4f46e5", secondary: "#06b6d4", lightBg: "#e0f2fe", gradient: "linear-gradient(135deg, #4f46e5 0%, #06b6d4 100%)"
};

const metaData = {
  stats: [["40+", "Smart Factories"], ["85%", "Avg. OEE Score"], ["30%", "Waste Reduction"]] as [string, string][],
  trust: ["IoT Gateway Ready ✓", "MES Integration ✓", "Predictive Analytics ✓", "ISO 9001 Certified ✓", "Cloud & On-Premise ✓", "Real-Time OEE ✓", "SCADA Integration ✓", "24/7 Monitoring ✓"],
  checks: ["OEE tracking & production dashboard", "IIoT device connectivity & SCADA sync", "Supply chain & inventory logistics", "Predictive maintenance automation", "ERP & warehouse management link"],
  h1: ["Smart ", "Manufacturing", " Software for Industry 4.0"] as [string, string, string]
};

import { IndustryCanvas } from "../IndustryCanvas";

export const ManufacturingPage: React.FC = () => {
  const industryKey = "manufacturing";
