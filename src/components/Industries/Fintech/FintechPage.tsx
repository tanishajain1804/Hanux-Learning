...
const themeColors = {
  primary: "#10b981", secondary: "#0ea5c9", lightBg: "#d1fae5", gradient: "linear-gradient(135deg, #1b4fd8 0%, #0ea5c9 100%)"
};

const metaData = {
  stats: [["150+", "FinTech Projects"], ["$2B+", "Transactions Processed"], ["99.99%", "Uptime SLA"]] as [string, string][],
  trust: ["PCI-DSS Level 1 ✓", "ISO 27001 ✓", "SOC 2 Type II ✓", "RBI Compliant ✓", "GDPR Ready ✓", "Bank-Grade Encryption ✓", "Real-Time Processing ✓", "99.99% Uptime ✓"],
  checks: ["Digital banking & neobank core systems", "Real-time payment rails & UPI integration", "Blockchain, DeFi & smart contract development", "AI-powered fraud detection & risk scoring", "RBI, SEBI & GDPR compliance built-in"],
  h1: ["Best ", "FinTech", " Software Development in Noida"] as [string, string, string]
};

import { IndustryCanvas } from "../IndustryCanvas";

export const FintechPage: React.FC = () => {
  const industryKey = "fintech";
