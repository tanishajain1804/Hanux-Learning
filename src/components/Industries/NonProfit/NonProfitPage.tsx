...
const themeColors = {
  primary: "#16a34a", secondary: "#10b981", lightBg: "#dcfce7", gradient: "linear-gradient(135deg, #16a34a 0%, #10b981 100%)"
};

const metaData = {
  stats: [["45+", "Portals Built"], ["$50M+", "Donations Processed"], ["40%", "Donor Growth"]] as [string, string][],
  trust: ["Donor CRM ✓", "Tax-Deductible Receipts ✓", "Recurring Giving Engines ✓", "Volunteer Portals ✓", "Grant Application Trackers ✓", "Compliance Auditors ✓", "Campaign Dashboards ✓", "Social Share Tickers ✓"],
  checks: ["Donor CRM & recurring giving engine", "Automated donation tax receipts", "Volunteer coordinator portal", "Fundraising campaign dashboards", "Grant tracking & audit logs"],
  h1: ["Modern ", "Non-Profit", " Software Solutions"] as [string, string, string]
};

import { IndustryCanvas } from "../IndustryCanvas";

export const NonProfitPage: React.FC = () => {
  const industryKey = "non-profit";
