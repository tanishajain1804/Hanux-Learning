...
const themeColors = {
  primary: "#7c3aed", secondary: "#ec4899", lightBg: "#f5f3ff", gradient: "linear-gradient(135deg, #7c3aed 0%, #ec4899 100%)"
};

const metaData = {
  stats: [["200+", "Campaign Dashboards"], ["4x", "Avg. ROAS Improvement"], ["₹100Cr+", "Ad Spend Tracked"]] as [string, string][],
  trust: ["Multi-Channel Analytics ✓", "Ad Network APIs ✓", "Lead Generation CRM ✓", "Attribution Models ✓", "Automated Reporting ✓", "Audience Builders ✓", "Creative Asset Sync ✓", "A/B Testing Engines ✓"],
  checks: ["Multi-channel ROI tracking dashboards", "Ad network API connections", "Lead generation CRM workflows", "Custom attribution algorithms", "Automated client reports scheduler"],
  h1: ["Modern ", "Marketing", " Automation Platforms"] as [string, string, string]
};

import { IndustryCanvas } from "../IndustryCanvas";

export const MarketingPage: React.FC = () => {
  const industryKey = "marketing";
