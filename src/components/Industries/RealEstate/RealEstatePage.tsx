...
const themeColors = {
  primary: "#059669", secondary: "#10b981", lightBg: "#d1fae5", gradient: "linear-gradient(135deg, #059669 0%, #10b981 100%)"
};

const metaData = {
  stats: [["90+", "Portals Developed"], ["5M+", "Listings Managed"], ["2.5x", "Lead Flow Boost"]] as [string, string][],
  trust: ["MLS Integration ✓", "3D Virtual Tours ✓", "RETS / RESO Web API ✓", "Leads Routing CRM ✓", "Automated Valuation ✓", "Multi-Tenant Portals ✓", "Tenant Screenings ✓", "Rent Payments ✓"],
  checks: ["Multi-tenant portals & agent CRMs", "RETS / RESO Web API integration", "Virtual tours & maps widgets", "Leads routing & campaigns automation", "Tenant screening & rent collection"],
  h1: ["Modern ", "Real Estate", " Software That Closes Deals"] as [string, string, string]
};

import { IndustryCanvas } from "../IndustryCanvas";

export const RealEstatePage: React.FC = () => {
  const industryKey = "real-estate";
