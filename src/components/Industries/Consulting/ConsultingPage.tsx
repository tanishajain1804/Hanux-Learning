...
const themeColors = {
  primary: "#1b4fd8", secondary: "#2563eb", lightBg: "#eef2ff", gradient: "linear-gradient(135deg, #1b4fd8 0%, #2563eb 100%)"
};

const metaData = {
  stats: [["110+", "Portals Built"], ["35%", "Billing Efficiency Gain"], ["98%", "Retention Rate"]] as [string, string][],
  trust: ["Client Collaboration Hubs ✓", "Timesheet Automations ✓", "Custom Reporting APIs ✓", "Multi-Currency Billing ✓", "Secure File Sync ✓", "Task Scheduling ✓", "Client Self-Service ✓", "Data Visualisations ✓"],
  checks: ["Client portal collaboration hubs", "Timesheet & project tracking logs", "Multi-currency invoicing & accounting", "Secure file repository & sync", "Activity dashboards & alerts"],
  h1: ["Modern ", "Consulting", " Platforms That Scaled"] as [string, string, string]
};

import { IndustryCanvas } from "../IndustryCanvas";

export const ConsultingPage: React.FC = () => {
  const industryKey = "consulting";
