...
// Local theme colors and metadata specific to Retail & E-commerce
const themeColors = {
  primary: "#2563eb",
  secondary: "#1d4ed8",
  lightBg: "#eff6ff",
...
const metaData = {
  stats: [["120+", "E-commerce Platforms"], ["₹1,200Cr", "Annual GMV"], ["3.4x", "Avg. Conversion Uplift"]] as [string, string][],
  trust: ["Shopify Plus Partner ✓", "WooCommerce Expert ✓", "Razorpay / Stripe ✓", "GST Compliant ✓", "Multi-Currency ✓", "Headless Commerce ✓", "PWA Ready ✓", "AI Recommendations ✓"],
  checks: ["Omnichannel shopping & headless commerce", "AI product search & recommendation engines", "High-throughput inventory & order routing", "GST, invoicing & payment gateways", "PWA & native mobile apps for retail"],
  h1: ["Retail & ", "E-commerce", " Platforms That Sell"] as [string, string, string]
};

import { IndustryCanvas } from "../IndustryCanvas";

export const EcommercePage: React.FC = () => {
  const industryKey = "ecommerce";
