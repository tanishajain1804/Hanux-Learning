...
const themeColors = {
  primary: "#0891b2", secondary: "#0ea5c9", lightBg: "#e0f7fa", gradient: "linear-gradient(135deg, #0891b2 0%, #0ea5c9 100%)"
};

const metaData = {
  stats: [["60+", "Logistics Platforms"], ["1M+", "Deliveries Routed"], ["22%", "Fuel Cost Saved"]] as [string, string][],
  trust: ["GPS Real-Time Tracking ✓", "Route Optimisation ✓", "Driver Dispatch App ✓", "Barcode & RFID Sync ✓", "Warehouse Management ✓", "API-First Carrier Link ✓", "Proof of Delivery ✓", "Cross-Docking Control ✓"],
  checks: ["Real-time GPS tracking & map overlays", "AI routing & fleet dispatch engine", "Driver logs & proof of delivery app", "Carrier API integrations", "Warehouse & cargo load controls"],
  h1: ["Smart ", "Logistics", " & Fleet Software"] as [string, string, string]
};

import { IndustryCanvas } from "../IndustryCanvas";

export const LogisticsPage: React.FC = () => {
  const industryKey = "logistics";
